...
public class User_KategoriFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.iv_kategorikamera) {
            Intent masuk_listkategori = new Intent(getView().getContext(), User_Kategori_list.class);
